              ...
              >
                <div className="relative">
                  <motion.div
                    ...
                    className="absolute inset-0 bg-gradient-to-br from-orange-500/30 to-purple-500/30 rounded-full blur-3xl"
                  />
                ...
                <p className="text-slate-400 mt-2 max-w-md text-center">
                  Get started by creating your first project and start building something
                  amazing.
                </p>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => setIsCreateOpen(true)}
                  className="mt-8 px-8 py-4 rounded-xl bg-gradient-to-r from-orange-500 via-red-500 to-purple-600 hover:from-orange-600 hover:via-red-600 hover:to-purple-700 text-white font-semibold shadow-lg shadow-orange-500/25 transition-all flex items-center gap-2"
                >
